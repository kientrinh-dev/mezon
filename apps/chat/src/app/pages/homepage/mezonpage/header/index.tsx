...
const HeaderMezon = memo((props: HeaderProps) => {
	...
	const NavLink: React.FC<NavLinkProps> = ({ href, section, label, 'data-e2e': dataE2E }) => (
		<a
			data-e2e={dataE2E}
			href={href}
				...
				<div className="flex items-center justify-between md:px-[32px] max-md:px-[16px] max-md:py-[14px] h-[80px] max-md:h-[72px]">
					<div className="flex items-center gap-[40px]">
						...
						<div className="hidden lg:flex items-center gap-3 lg:max-xl:gap-[0.05rem]">
							<NavLink href="#home" section="home" label="Home" data-e2e={generateE2eId('homepage.header.link.home')} />
							<NavLink href="#overview" section="overview" label="Overview" data-e2e={generateE2eId('homepage.header.link.overview')} />
							<NavLink href="#feature" section="feature" label="Features" data-e2e={generateE2eId('homepage.header.link.features')} />
							<a
